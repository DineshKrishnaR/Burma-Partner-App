String base_url = "https://burmaadmin.yetloapps.com/Android_API/Partners_App/api-1.2.1/";
...
String getstatelist = 'account.php';
...
String manicategorytocategory = 'site_dtl.php';
String getsubcategorybycategory = 'site_dtl.php';
String getmainsubcattoproduct = 'site_dtl.php';
...
String getdeliverycharges = 'deliv-charge.php';
...
String getcertification = 'site_dtl.php';
String getleaderboard = 'sales_info.php';
String getsalesreport = 'sales_info.php';

//home sections
String gethomesectioncategory = 'site_dtl.php';
String gethomesectionproductgrid = 'get_section_products.php';
String gethomesectionsubcategory = 'site_dtl.php';
...
// Wallet
String getwallettransactions = 'order.php';
String requestwithdrawa = 'site_dtl.php';



//ReferalCustomer   9876549870
String getcustomerslist = 'site_dtl.php';
String addreferecustomer = 'register.php';
String gercustomerdetails = 'site_dtl.php';
String getreferalcustomerreport = 'sales_info.php';
